...
public abstract class AbstractAuthorizeTag {
    ...
    private SecurityExpressionHandler<FilterInvocation> getExpressionHandler() throws IOException {
        /*
        原因：
            AbstractAuthorizeTag 类默认是查找“根级别”的IOC 容器。而根级别的IOC 容器中没有扫描SpringSecurity 的配置类，所以没有相关的bean。
        解决办法：
            修改AbstractAuthorizeTag 类的源码。
         */
        // 注释查找“根级别”的IOC 容器的源码
        ...
        // 拼接SpringMVC 在ServletContext 域中的属性名
        String attrName = FrameworkServlet.SERVLET_CONTEXT_PREFIX + "springDispatcherServlet";
        // 从ServletContext 域中获取IOC 容器对象
        ApplicationContext appContext = (ApplicationContext) application.getAttribute(attrName);
